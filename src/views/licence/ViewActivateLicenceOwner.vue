<template lang="pug">
ActivateLicenceBaseStep.ViewActivateLicenceOwner(
...
import DragDropZone from '@/components/licence/DragDropZone'
...
export default {
  ...
  methods: {
    ...
    async next () {
      this.cleanError()
      this.name = cleanWhitespaces(this.name)
...
.ViewActivateLicenceOwner > .layout {
  display: grid;
